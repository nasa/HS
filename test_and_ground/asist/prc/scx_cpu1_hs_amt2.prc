...
SCX_CPU1_HS_AMT[4].ActionType = HS_AMT_ACT_PROC_RESET
...
s create_tbl_file_from_cvt (hostCPU,apid,"App Monitoring Table Load 2","hs_def_amt2",amtTblName,"SCX_CPU1_HS_AMT[1].AppName",endmnemonic)

;; Restore procedure logging
%liv (log_procedure) = logging

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_amt2 "
write ";*********************************************************************"
ENDPROC
