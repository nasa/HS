...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1000;1003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_NOOP_INF_EID,"."
  ut_setrequirements HS_1000, "F"
  ut_setrequirements HS_1003, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_SET_COUNTERS_INF_EID, "INFO", 1

/SCX_CPU1_TST_HS_SetCounters
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_HS_SET_COUNTERS_INF_EID,"."
endif
...
if (SCX_CPU1_HS_CMDPC > 0) AND (SCX_CPU1_HS_CMDEC > 0) THEN 
  write "<*> Counters are all non-zero. Sending reset command."

  ;; Send the reset command
  ut_setupevents "SCX", "CPU1", {HSAppName}, HS_RESET_DBG_EID, "DEBUG", 1

  cmdCtr = SCX_CPU1_HS_CMDPC + 1

  ;; Send the Reset Command
  /SCX_CPU1_HS_ResetCtrs
  wait 5
  ...
  if (UT_TW_Status = UT_Success) then
    ...
    write "<!> Failed (1001;1003) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_RESET_DBG_EID,"."
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{HSAppName},HS_DISABLE_ALIVENESS_DBG_EID,"DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_DisableCPUAlive
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6007) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_NOOP_INF_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_6007, "F"
endif
...
if (p@SCX_CPU1_HS_CPUAliveState = "Disabled") then
  write "<*> Passed (6007) - Telemetry indicates CPU Alive State is Disabled."
  ut_setrequirements HS_6007, "P"
else
  write "<!> Failed (6007) - Telemetry indicates incorrect CPU Alive State of ", p@SCX_CPU1_HS_CPUAliveState,". Expected Disabled."
  ut_setrequirements HS_6007, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{HSAppName},HS_ENABLE_ALIVENESS_DBG_EID,"DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_EnableCPUAlive
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6006) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_ENABLE_ALIVENESS_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_6006, "F"
endif
...
if (p@SCX_CPU1_HS_CPUAliveState = "Enabled") then
  write "<*> Passed (6006) - Telemetry indicates CPU Alive State is Enabled."
  ut_setrequirements HS_6006, "P"
else
  write "<!> Failed (6006) - Telemetry indicates incorrect CPU Alive State of ", p@SCX_CPU1_HS_CPUAliveState,". Expected Enabled."
  ut_setrequirements HS_6006, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_SET_RESETS_PERFORMED_INF_EID, "INFO", 1

/SCX_CPU1_TST_HS_SetResetsPerformed
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_HS_SET_RESETS_PERFORMED_INF_EID,"."
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_RESET_RESETS_DBG_EID, "DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_ResetPRCtr
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;7000) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_RESET_RESETS_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_7000, "F"
endif
...
if (SCX_CPU1_HS_PRResetCtr = 0) then
...
cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_SetMaxResetCnt NewCount=25
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_DISABLE_CPUHOG_DBG_EID, "DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_DisableCPUHog
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6012) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_DISABLE_CPUHOG_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_6012, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_ENABLE_CPUHOG_DBG_EID, "DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_EnableCPUHog
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;6011) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_ENABLE_CPUHOG_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_6011, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_CC_ERR_EID, "ERROR", 1
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HS_CC_ERR_EID, "."
  ut_setrequirements HS_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, 103, "INFO", 1

;; Send the Command
/SCX_CPU1_HS_ReportDiag
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, 104, "DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1

;; Send the Command
/SCX_CPU1_HS_SetUtilParams Factor1=2500 Divisor=50505 Factor2=1
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, 106, "DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1

;; Send the Command
/SCX_CPU1_HS_SetUtilMask UtilMask=x'FFFF'
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_gencmds"
write ";*********************************************************************"
ENDPROC
