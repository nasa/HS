...
s create_tbl_file_from_cvt (hostCPU,apid,"Event Monitoring Table Load 2","hs_def_emt2",emtTblName,"SCX_CPU1_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_emt2 "
write ";*********************************************************************"
ENDPROC
