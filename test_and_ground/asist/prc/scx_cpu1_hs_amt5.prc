...
SCX_CPU1_HS_AMT[6].ActionType = HS_AMT_ACT_APP_RESTART
...
s create_tbl_file_from_cvt (hostCPU,apid,"App Monitoring Table Load 5","hs_def_amt5",amtTblName,"SCX_CPU1_HS_AMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_amt5 "
write ";*********************************************************************"
ENDPROC
