...
if (p@SCX_CPU1_HS_CPUHogState = "Enabled") then
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_HOG_CPU_INF_EID, "INFO", 2
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_CPUMON_HOGGING_ERR_EID, "ERROR", 3

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_SetUtilMask UtilMask=x'3F'
...
;;else
;;  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_HS_SET_UTIL_MASK_INF_EID,"."
;;endif

;; Send the CPU Hog command
cmdCtr = SCX_CPU1_TST_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_TST_HS_HOGCPU HogCount=100000
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_HS_HOG_CPU_INF_EID,"."
endif

;; Check if the Average and Peak Utilization are > 0
if (SCX_CPU1_HS_CPUUtilAve > 0) then
...
if (SCX_CPU1_HS_CPUUtilPeak > 0) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (6010) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_CPUMON_HOGGING_ERR_EID,"."
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_cpuhog"
write ";*********************************************************************"
ENDPROC
