...
/SCX_CPU1_ES_RestartApp Application="HS"
wait 5
...
if (SCX_CPU1_HS_CMDPC = 0) AND (SCX_CPU1_HS_CMDEC = 0) AND ;;
   (SCX_CPU1_HS_PRResetCtr = 0) AND ;;
   ...
   (SCX_CPU1_HS_CPUHOGState = HS_CPUHOG_DEFAULT_STATE) AND ;;
  ...
  ;;   SCX_CPU1_HS_CPUUtilAve; SCX_CPU1_HS_CPUUtilPeak; SCX_CPU1_HS_APPStatus
  ;;***************************************************************************
else
  write "<!> Failed (8000) - Housekeeping telemetry NOT initialized properly at startup."
  write "CMDPC           = ", SCX_CPU1_HS_CMDPC
  write "CMDEC           = ", SCX_CPU1_HS_CMDEC
  write "PRResetCtr      = ", SCX_CPU1_HS_PRResetCtr
  write "MaxResetCount   = ", SCX_CPU1_HS_MaxResetCnt
  write "InvalidEVTApps  = ", SCX_CPU1_HS_InvalidEVTAppCnt
  write "AppMonState     = ", p@SCX_CPU1_HS_AppMonState
  write "EventMonState   = ", p@SCX_CPU1_HS_EvtMonState
  write "CPU Hog State   = ", SCX_CPU1_HS_CPUHOGState
  write "CPUAliveState   = ", p@SCX_CPU1_HS_CPUAliveState
...
/SCX_CPU1_EVS_EnaAppEVTType Application=HSAppName DEBUG
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_DISABLE_APPMON_DBG_EID, "DEBUG",1

local cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_DisableAppMon

ut_tlmwait  SCX_CPU1_HS_CMDPC, {cmdCtr}
if (UT_TW_Status = UT_Success) then
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_DISABLE_APPMON_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_2002, "F"
endif
...
if (p@SCX_CPU1_HS_AppMonState = "Disabled") then
  write "<*> Passed (2002) - Telemetry indicates Application Monitoring State is Disabled."
  ut_setrequirements HS_2002, "P"
else
  write "<!> Failed (2002) - Telemetry indicates incorrect Application Monitoring State of ", p@SCX_CPU1_HS_AppMonState,". Expected Disabled."
  ut_setrequirements HS_2002, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_LEN_ERR_EID, "ERROR",1

local errcnt = SCX_CPU1_HS_CMDEC + 1
...
if (SCX_CPU1_find_event[1].num_found_messages = 1) THEN
  ...
  write "<!> Failed (1004) - Event message ",SCX_CPU1_evs_eventid," received. Expected Event message ",HS_LEN_ERR_EID, "."
  ut_setrequirements HS_1004, "F"
endif
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_ENABLE_APPMON_DBG_EID, "DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_EnableAppMon
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;2001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_ENABLE_APPMON_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_2001, "F"
endif
...
if (p@SCX_CPU1_HS_AppMonState = "Enabled") then
  write "<*> Passed (2001) - Telemetry indicates Application Monitoring State is Enabled."
  ut_setrequirements HS_2001, "P"
else
  write "<!> Failed (2001) - Telemetry indicates incorrect Application Monitoring State of ", p@SCX_CPU1_HS_AppMonState,". Expected Enabled."
  ut_setrequirements HS_2001, "F"
endif
...
write ";***********************************************************************"
s get_tbl_to_cvt(ramDir,AppMonTblName, "A", "cpu1_hs_dumpamt", hostCPU, amtAPID)
wait 5
...
if (SCX_CPU1_HS_AppStatus[1] = 0x1F) then
  write "<*> Passed (2000) - Telemetry indicates that all applications are executing."
  ut_setrequirements HS_2000, "P"
else
  write "<!> Failed (2000) - Telemetry indicates ", SCX_CPU1_HS_AppStatus,". Expected 0x1F."
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_AMTVAL_INF_EID, "INFO", 2
...
local expectedResetCtr = SCX_CPU1_HS_PRResetCtr + 1

ut_setupevents "SCX", "CPU1", "CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",1
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_APPMON_PROC_ERR_EID, "ERROR", 2
...
if (SCX_CPU1_HS_PRResetCtr = expectedResetCtr) then
  write "<*> Passed (2000.1.1) - cFE Processor Reset occurred and Counter incremented as expected."
  ut_setrequirements HS_200011, "P"
else
  write "<!> Failed (2000.1.1) - The cFE Processor Reset Counter indicated ",SCX_CPU1_HS_PRResetCtr,". Expected ",expectedResetCtr
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1","CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_APPMON_FAIL_ERR_EID, "ERROR", 2
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_APPMON_MSGACTS_ERR_EID, "ERROR", 2
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_NOOP_INF_EID, "INFO", 3

local expectedMsgActCtr = SCX_CPU1_HS_MsgActCnt + 1
...
ut_tlmwait SCX_CPU1_HS_MsgActCnt, {expectedMsgActCtr}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - SB Message Action counter incremented."
else
  write "<!> Failed - SB Message Action counter did not increment as expected. Got ",SCX_CPU1_HS_MsgActCnt,"; Expected ",expectedMsgActCtr
endif
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_SET_MAX_RESETS_DBG_EID, "DEBUG", 1

local origMaxResetCnt = SCX_CPU1_HS_MaxResetCnt
cmdCtr = SCX_CPU1_HS_CMDPC + 1

;; Send the Command
/SCX_CPU1_HS_SetMaxResetCnt NewCount=SCX_CPU1_HS_PRResetCtr
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "CMDPC = ",SCX_CPU1_HS_CMDPC, " Expected ", cmdCtr
  ut_setrequirements HS_1003, "F"
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;7001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_SET_MAX_RESETS_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_7001, "F"
endif
...
write ";*********************************************************************"
;; Before activating the table, save the Reset Counter
expectedResetCtr = SCX_CPU1_HS_PRResetCtr + 1

ut_setupevents "SCX", "CPU1", "CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_RESET_LIMIT_ERR_EID, "ERROR", 2
...
cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_SetMaxResetCnt NewCount=origMaxResetCnt
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_APPMON_RESTART_ERR_EID, "ERROR", 2
...
write "AppStatus = ", scx_cpu1_hs_appstatus
if (SCX_CPU1_HS_APPSTATUS = 0x1F) then
...
write ";***********************************************************************"
;s scx_cpu1_hs_start_apps("4.10.1")
;wait 5
...
if (SCX_CPU1_HS_PRResetCtr = expectedResetCtr) then
  ...
  write "<!> Failed (2000.2.1) - The cFE Processor Reset Counter indicated ",SCX_CPU1_HS_PRResetCtr,". Expected ",expectedResetCtr
...
ut_setupevents "SCX", "CPU1", "CFE_TBL",CFE_TBL_UPDATE_SUCCESS_INF_EID,"INFO",1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_APPMON_MSGACTS_ERR_EID, "ERROR", 2
;ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_NOOP_INF_EID, "INFO", 3
ut_setupevents "SCX", "CPU1", "CFE_EVS", 0, "INFO", 3

expectedMsgActCtr = SCX_CPU1_HS_MsgActCnt + 1
cmdCtr = SCX_CPU1_TBL_CMDPC + 1
...
ut_tlmwait scx_cpu1_find_event[3].num_found_messages, 1
if (UT_TW_Status = UT_Success) then
  write "<*> Passed (2000.2) - Rcv'd the Event from the SB Message (EVS_NOOP command) event"
  ; write "<*> Passed (2000.2) - Rcv'd the Event from the SB Message (TST_HS_NOOP command) event"
  ut_setrequirements HS_20002c, "P"
else
  write "<!> Failed (2000.2) - Did not rcv the SB Message (EVS_NOOP command) event"
...
origMaxResetCnt = SCX_CPU1_HS_MaxResetCnt
cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_SetMaxResetCnt NewCount=SCX_CPU1_HS_PRResetCtr
...
for index = 1 to HS_MAX_MONITORED_APPS do
  if (SCX_CPU1_HS_AMT[index].AppName = "") then
    break
  endif
enddo
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "CFE_TBL", CFE_TBL_VALIDATION_ERR_EID, "ERROR", 1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_AMTVAL_INF_EID, "INFO", 2
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_AMTVAL_ERR_EID, "ERROR", 3
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_AMT_LD_ERR_EID, "ERROR", 3
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EMT_LD_ERR_EID, "ERROR", 4
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_XCT_LD_ERR_EID, "ERROR", 5
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_MAT_LD_ERR_EID, "ERROR", 6

;s scx_cpu1_hs_start_apps("6.5")
;wait 5

; Restart the HS app to generated the error messages
/SCX_CPU1_ES_RestartApp Application="HS"
wait 5

;s load_start_app ("HS",hostCPU,"HS_AppMain")
;wait 5
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_appmon "
write ";*********************************************************************"
ENDPROC
