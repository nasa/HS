...
SCX_CPU1_HS_XCT[5].ResourceType = HS_XCT_TYPE_APP_MAIN

;; Entry 6
SCX_CPU1_HS_XCT[6].ResourceName = "SC"
SCX_CPU1_HS_XCT[6].NullTerm = 0
SCX_CPU1_HS_XCT[6].ResourceType = HS_XCT_TYPE_APP_MAIN

;; Entry 7
SCX_CPU1_HS_XCT[7].ResourceName = "TST_SC"
SCX_CPU1_HS_XCT[7].NullTerm = 0
SCX_CPU1_HS_XCT[7].ResourceType = HS_XCT_TYPE_APP_MAIN
...
s create_tbl_file_from_cvt (hostCPU,apid,"Execution Counter Table Load 2","hs_def_xct2",xctTblName,"SCX_CPU1_HS_XCT[1].ResourceName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_xct2 "
write ";*********************************************************************"
ENDPROC
