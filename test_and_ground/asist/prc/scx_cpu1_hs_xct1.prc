...
s create_tbl_file_from_cvt (hostCPU,apid,"Execution Counter Table Load 1","hs_def_xct1",xctTblName,"SCX_CPU1_HS_XCT[1].ResourceName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_xct1 "
write ";*********************************************************************"
ENDPROC
