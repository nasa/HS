...
if (SCX_CPU1_HS_CMDPC = 0) AND (SCX_CPU1_HS_CMDEC = 0) AND ;;
  ...
  write "WatchdogFlag    = ", p@SCX_CPU1_TST_HS_WatchdogFlag
...
if (SCX_CPU1_HS_EVTMonCnt > 0) then
...
if (p@SCX_CPU1_HS_AppMonState = "Enabled") then
  ...
  ;; Dump the table 
  s get_tbl_to_cvt(ramDir,EvtMonTblName,"A","cpu1_hs_dumpamt",hostCPU,amtAPID)
  wait 5
...
s get_tbl_to_cvt(ramDir,ExeCntTblName, "A", "cpu1_hs_dumpxct", hostCPU, xctAPID)
wait 5

;; If an entry contains a ResourceName, the table was loaded
for index = 1 to HS_MAX_EXEC_CNT_SLOTS do
  if (SCX_CPU1_HS_XCT[index].ResourceName <> "") then
    break
  endif
enddo
...
write ";*********************************************************************"
local savedPRResets = SCX_CPU1_HS_PRResetCtr
local savedMaxResets = SCX_CPU1_HS_MaxResetCnt
...
if (SCX_CPU1_HS_PRResetCtr = savedPRResets) AND ;;
   (SCX_CPU1_HS_MaxResetCnt = savedMaxResets) then
  ...
  write "Expected '",savedPRResets,"'; got '",SCX_CPU1_HS_PRResetCtr,"'"
  write "Expected '",savedMaxResets,"'; got '",SCX_CPU1_HS_MaxResetCnt,"'"
...
;; Send the Command
/SCX_CPU1_HS_SetMaxResetCnt NewCount=15
wait 5
...
write ";*********************************************************************"
;; Save the values
savedPRResets = SCX_CPU1_HS_PRResetCtr
savedMaxResets = SCX_CPU1_HS_MaxResetCnt

;; Before stopping the HS application, disable the Watchdog timer
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_DISABLE_WATCHDOG_INF_EID, "INFO", 1

/SCX_CPU1_TST_HS_DisableWatchdog
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",TST_HS_DISABLE_WATCHDOG_INF_EID,"."
endif
...
/SCX_CPU1_ES_DELETEAPP Application="TST_HS"
wait 4
/SCX_CPU1_ES_DELETEAPP Application=HSAppName
wait 4
...
wait 5
s load_app(defTblDir,"CS",hostCPU)
wait 5
...
write ";*********************************************************************"
cmdCtr = SCX_CPU1_TST_HS_CMDPC + 1

/SCX_CPU1_TST_HS_SetStartupDelay
wait 5

ut_tlmwait  SCX_CPU1_TST_HS_CMDPC, {cmdCtr}
if (UT_TW_Status = UT_Success) then
  write "<*> Passed - TST_HS Set Startup Delay Flag command sent properly."
else
  write "<!> Failed - TST_HS Set Startup Delay Flag command. CMDPC = ",SCX_CPU1_TST_HS_CMDPC, "; expected ",cmdCtr
endif
...
/SCX_CPU1_TO_ADDPACKET STREAM=hs_stream PKT_SIZE=X'0' PRIORITY=X'0' RELIABILITY=X'0' BUFLIMIT=x'4'
wait 5

/SCX_CPU1_TO_ADDPACKET STREAM=tst_hs_stream PKT_SIZE=X'0' PRIORITY=X'0' RELIABILITY=X'0' BUFLIMIT=x'4'
wait 5
...
/SCX_CPU1_TST_HS_RemoveStartupDelay
wait 5
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed - TST_HS Remove Startup Delay command. CMDPC = ",SCX_CPU1_TST_HS_CMDPC, "; expected ",cmdCtr
endif
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_reset "
write ";*********************************************************************"
ENDPROC
