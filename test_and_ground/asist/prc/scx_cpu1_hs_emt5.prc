...
SCX_CPU1_HS_EMT[6].ActionType = HS_EMT_ACT_LAST_NONMSG+2
...
s create_tbl_file_from_cvt (hostCPU,apid,"Event Monitoring Table Load 5","hs_def_emt5",emtTblName,"SCX_CPU1_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_emt5 "
write ";*********************************************************************"
ENDPROC
