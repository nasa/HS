...
write ";***********************************************************************"
ut_setupevents "SCX","CPU1",{HSAppName},HS_DISABLE_EVENTMON_DBG_EID,"DEBUG",1

local cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_DisableEvtMon
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5002) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_DISABLE_EVENTMON_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_5002, "F"
endif
...
if (p@SCX_CPU1_HS_EVTMonState = "Disabled") then
  write "<*> Passed (2002) - Telemetry indicates Event Monitoring State is Enabled."
  ut_setrequirements HS_2002, "P"
else
  write "<!> Failed (2002) - Telemetry indicates incorrect Event Monitoring State of ", p@SCX_CPU1_HS_EVTMonState,". Expected Disabled."
...
write ";***********************************************************************"
ut_setupevents "SCX", "CPU1",{HSAppName},HS_ENABLE_EVENTMON_DBG_EID,"DEBUG", 1

cmdCtr = SCX_CPU1_HS_CMDPC + 1
;; Send the Command
/SCX_CPU1_HS_EnableEvtMon
...
if (UT_TW_Status = UT_Success) then
  ...
  write "<!> Failed (1003;5001) - Event message ", SCX_CPU1_evs_eventid," rcv'd. Expected Event Msg ",HS_ENABLE_EVENTMON_DBG_EID,"."
  ut_setrequirements HS_1003, "F"
  ut_setrequirements HS_5001, "F"
endif
...
;; Check that the Critical Event Monitoting Parameter is set to Disabled
if (p@SCX_CPU1_HS_EVTMonState = "Enabled") then
  write "<*> Passed (5001) - Telemetry indicates Event Monitoring State is Enabled."
  ut_setrequirements HS_5001, "P"
else
  write "<!> Failed (5001) - Telemetry indicates incorrect Event Monitoring State of ", p@SCX_CPU1_HS_EVTMonState,". Expected Enabled."
  ut_setrequirements HS_5001, "F"
endif
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EMTVAL_INF_EID, "INFO", 2
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1","TST_HS", TST_HS_NOOP_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{HSAppName}, HS_EVENTMON_RESTART_ERR_EID,"ERROR", 2
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_INIT_INF_EID, "INFO", 3

;; Send the command
/SCX_CPU1_TST_HS_NOOP
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_NOOP_INF_EID, "INFO", 1
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EVENTMON_PROC_ERR_EID, "ERROR", 2
...
if (SCX_CPU1_HS_PRResetCtr = expectedResetCtr) then
  ...
  write "<*> Failed (5000.1.1) - The cFE Processor Reset Counter indicated ",SCX_CPU1_HS_PRResetCtr,". Expected ",expectedResetCtr
...
write ";*********************************************************************"
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_NOOP_INF_EID, "INFO", 1
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EVENTMON_DELETE_ERR_EID, "ERROR", 2
...
ut_setupevents "SCX", "CPU1", "TST_HS", TST_HS_INIT_INF_EID, "INFO", 2
...
write ";*********************************************************************"
ut_setupevents "SCX","CPU1",{HSAppName},HS_NOOP_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{HSAppName},HS_EVENTMON_MSGACTS_ERR_EID, "ERROR", 2
...
if (SCX_CPU1_HS_MsgActCnt = expectedMsgActCtr) then
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EVENTMON_PROC_ERR_EID, "ERROR", 3
...
write ";*********************************************************************"
s get_tbl_to_cvt(ramDir, EvtMonTblName, "A", "cpu1_hs_dumpemt", hostCPU, emtAPID)
wait 5

local index
;; Check that all the application slots are filled
for index = 1 to HS_MAX_MONITORED_EVENTS do
  if (SCX_CPU1_HS_EMT[index].AppName = "") then
    break
  endif
enddo
...
ut_tlmwait {seqTlmItem}, {expectedSCnt}
if (UT_TW_Status = UT_Success) then
  if (scx_cpu1_HS_InvalidEVTAppCnt = 2) then
    write "<*> Passed (5000.2) - HS Invalid/Unknown App Counter is correct."
    ut_setrequirements HS_50002, "P"
  else
    write "<!> Failed (5000.2) - HS Invalid/Unknown App Counter reported ",SCX_CPU1_HS_InvalidEVTAppCnt, "; Expected 2."
...
ut_setupevents "SCX","CPU1","TST_HS", TST_HS_NOOP_INF_EID, "INFO", 1
ut_setupevents "SCX","CPU1",{HSAppName},HS_EVENTMON_MSGACTS_ERR_EID,"ERROR", 2
ut_setupevents "SCX","CPU1",{HSAppName},HS_EVENTMON_RESTART_ERR_EID,"ERROR", 3
...
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EMTVAL_INF_EID, "INFO", 2
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_EMTVAL_ERR_EID, "ERROR", 3
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_eventmon "
write ";*********************************************************************"
ENDPROC
