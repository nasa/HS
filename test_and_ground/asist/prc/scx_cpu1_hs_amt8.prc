...
SCX_CPU1_HS_AMT[6].ActionType = HS_AMT_ACT_LAST_NONMSG+2
...
s create_tbl_file_from_cvt (hostCPU,apid,"App Monitoring Table Load 8","hs_def_amt8",amtTblName,"SCX_CPU1_HS_AMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_amt8 "
write ";*********************************************************************"
ENDPROC
