...
SCX_CPU1_HS_EMT[2].NullTerm = 5
SCX_CPU1_HS_EMT[2].EventID = 10
SCX_CPU1_HS_EMT[2].ActionType = HS_EMT_ACT_APP_DELETE
...
SCX_CPU1_HS_EMT[6].ActionType = HS_EMT_ACT_LAST_NONMSG + HS_MAX_MSG_ACT_TYPES + 1
...
s create_tbl_file_from_cvt (hostCPU,apid,"Event Monitoring Table Invalid Load","hs_def_emt8",emtTblName,"SCX_CPU1_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_emt8 "
write ";*********************************************************************"
ENDPROC
