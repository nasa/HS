...
SCX_CPU1_HS_AMT[4].ActionType = HS_AMT_ACT_LAST_NONMSG+1

;; Entry 5
SCX_CPU1_HS_AMT[5].AppName = "CFE_SB"
SCX_CPU1_HS_AMT[5].NullTerm = 0
SCX_CPU1_HS_AMT[5].CycleCnt = 10
SCX_CPU1_HS_AMT[5].ActionType = HS_AMT_ACT_NOACT
...
s create_tbl_file_from_cvt (hostCPU,apid,"App Monitoring Table Load 4","hs_def_amt4",amtTblName,"SCX_CPU1_HS_AMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_amt4 "
write ";*********************************************************************"
ENDPROC
