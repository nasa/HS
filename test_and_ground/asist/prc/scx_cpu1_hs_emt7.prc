...
;; Entry 6
SCX_CPU1_HS_EMT[6].AppName = "UK_APP1"
SCX_CPU1_HS_EMT[6].NullTerm = 0
SCX_CPU1_HS_EMT[6].EventID = 10
SCX_CPU1_HS_EMT[6].ActionType = HS_EMT_ACT_APP_RESTART

;; Entry 7
SCX_CPU1_HS_EMT[7].AppName = "UK_APP2"
SCX_CPU1_HS_EMT[7].NullTerm = 0
SCX_CPU1_HS_EMT[7].EventID = 10
SCX_CPU1_HS_EMT[7].ActionType = HS_EMT_ACT_APP_DELETE
...
s create_tbl_file_from_cvt (hostCPU,apid,"Event Monitoring Table Load 7","hs_def_emt7",emtTblName,"SCX_CPU1_HS_EMT[1].AppName",endmnemonic)

write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_emt7 "
write ";*********************************************************************"
ENDPROC
