...
ut_setupevents "SCX", "CPU1", "CFE_ES", CFE_ES_RESTART_APP_INF_EID, "INFO", 3
ut_setupevents "SCX", "CPU1", "TST_ES2", 1, "INFO", 4
ut_setupevents "SCX", "CPU1", {HSAppName}, HS_APPMON_RESTART_ERR_EID, "ERROR", 5
...
if (scx_cpu1_find_event[5].num_found_messages = 1) AND ;;
   (scx_cpu1_find_event[3].num_found_messages = 1) AND ;;
   (scx_cpu1_find_event[4].num_found_messages = 1) then
    ...
    write "--Event 3 messages = ",scx_cpu1_find_event[3].num_found_messages
    write "--Event 4 messages = ",scx_cpu1_find_event[4].num_found_messages
    write "--Event 5 messages = ",scx_cpu1_find_event[5].num_found_messages
endif
...
for index = 1 to HS_MAX_MONITORED_APPS do
  if (SCX_CPU1_HS_AMT[index].AppName = "") then
    break
  elseif (SCX_CPU1_HS_AMT[index].AppName = "TST_ES2") then
    es2Slot = index
  endif
enddo
...
local tst_es2Status = %and(SCX_CPU1_HS_APPSTATUS,tst_es2Mask)
write "HS App Status  = ", %hex(SCX_CPU1_HS_APPSTATUS)
...
write ";*********************************************************************"
write ";  End procedure SCX_CPU1_hs_stress"
write ";*********************************************************************"
ENDPROC
