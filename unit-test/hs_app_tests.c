...
int32 HS_APP_TEST_CFE_ES_RestoreFromCDSHook(void                   *UserObj,
                                            int32                   StubRetcode,
                                            uint32                  CallCount,
                                            const UT_StubContext_t *Context)
{
...
int32 HS_APP_TEST_CFE_ES_WaitForStartupSyncHook1(void                   *UserObj,
                                                 int32                   StubRetcode,
                                                 uint32                  CallCount,
                                                 const UT_StubContext_t *Context)
{
...
int32 HS_APP_TEST_CFE_EVS_RegisterHook(void                   *UserObj,
                                       int32                   StubRetcode,
                                       uint32                  CallCount,
                                       const UT_StubContext_t *Context)
{
...
int32 HS_APP_TEST_CFE_ES_ExitAppHook(void                   *UserObj,
                                     int32                   StubRetcode,
                                     uint32                  CallCount,
                                     const UT_StubContext_t *Context)
{
...
void HS_AppMain_Test_NominalRcvMsgSuccess(void)
{
    ...
    /* Verify results */
    UtAssert_UINT32_EQ(HS_AppData.EventsMonitoredCount, 1);
...
void HS_AppInit_Test_Nominal(void)
{
    ...
    UtAssert_UINT32_EQ(HS_AppData.ServiceWatchdogFlag, HS_State_ENABLED);
    UtAssert_UINT32_EQ(HS_AppData.AlivenessCounter, 0);
     ...
     * subfunction that we don't care about here */
    UtAssert_UINT32_EQ(HS_AppData.CurrentAlivenessState, HS_ALIVENESS_DEFAULT_STATE);
    UtAssert_UINT32_EQ(HS_AppData.CurrentCPUHogState, HS_CPUHOG_DEFAULT_STATE);
    ...
    UtAssert_UINT16_EQ(HS_AppData.CDSData.MaxResets, HS_MAX_RESTART_ACTIONS);
...
void HS_AppInit_Test_DisableSavingToCDS(void)
{
    ...
    /* Verify results */
    UtAssert_UINT32_EQ(Result, CFE_SUCCESS);
    UtAssert_UINT32_EQ(HS_AppData.CDSState, HS_State_DISABLED);
...
void HS_TblInit_Test_LoadExeCountTableError(void)
{
    ...
    /* Verify results */
    UtAssert_UINT32_EQ(Result, CFE_SUCCESS);
    /* Note: not verifying that HS_AppData.ExecMonLoaded == HS_State_DISABLED, because HS_AppData.ExecMonLoaded is
    ...
    UtAssert_STUB_COUNT(CFE_EVS_SendEvent, 6);
}
...
void HS_TblInit_Test_LoadMsgActsTableError(void)
{
    ...
    /* Verify results */
    UtAssert_UINT32_EQ(Result, CFE_SUCCESS);
    /* Note: not verifying that HS_AppData.MsgActsLoaded == HS_State_DISABLED, because HS_AppData.MsgActsLoaded is
     * modified by HS_AcquirePointers at the end of HS_TblInit */
...
void HS_ProcessMain_Test(void)
{
    ...
    MAStatePtr->Cooldown = 2;
    MAStatePtr           = HS_GetMAStateByIndex(HS_MAX_MSG_ACT_TYPES / 2);
    MAStatePtr->Cooldown = 2;
    MAStatePtr           = HS_GetMAStateByIndex(HS_MAX_MSG_ACT_TYPES - 1);
    MAStatePtr->Cooldown = 2;
    ...
    UtAssert_STUB_COUNT(HS_MsgAct_Cooldown, 1);
    UtAssert_UINT32_EQ(HS_AppData.AlivenessCounter, 0);
...
void HS_ProcessMain_Test_MonStateDisabled(void)
{
    ...
    /* Prevent HS_AppMon_CheckAllApps() from executing */
...
void HS_ProcessMain_Test_AlivenessDisabled(void)
{
    ...
    /* Check first, middle, and last element */
    UtAssert_STUB_COUNT(HS_MsgAct_Cooldown, 1);
    UtAssert_UINT32_EQ(HS_AppData.AlivenessCounter, HS_CPU_ALIVE_PERIOD);
...
void HS_ProcessCommands_Test(void)
{
    ...
    UtAssert_STUB_COUNT(HS_AppPipe, 1);
    UtAssert_STUB_COUNT(HS_EventMon_Check, 1);
...
void HS_ProcessCommands_Test_NullMsgPtr(void)
{
    ...
    /* Verify results */
    UtAssert_UINT32_EQ(Result, CFE_SB_TIME_OUT);
    UtAssert_UINT32_EQ(HS_AppData.EventsMonitoredCount, 0);

    UtAssert_STUB_COUNT(CFE_SB_ReceiveBuffer, 4);
    UtAssert_STUB_COUNT(HS_AppPipe, 0);

    UtAssert_UINT32_EQ(HS_AppData.CmdErrCount, 0);
}

void HS_ComputeStatusFlags_Test(void)
{
    /*
     * Test Case For:
    ...
    UtAssert_VOIDCALL(HS_ComputeStatusFlags(&StatusFlags));
    UtAssert_ZERO(StatusFlags);
    ...
    UtAssert_VOIDCALL(HS_ComputeStatusFlags(&StatusFlags));
    UtAssert_UINT8_EQ(StatusFlags, HS_StatusFlag_LOADED_AMT | HS_StatusFlag_LOADED_MAT | HS_StatusFlag_CDS_IN_USE);
    ...
    UtAssert_VOIDCALL(HS_ComputeStatusFlags(&StatusFlags));
    UtAssert_UINT8_EQ(StatusFlags, HS_StatusFlag_LOADED_EMT | HS_StatusFlag_LOADED_XCT);
}
...
void HS_SetCDSData_Test(void)
{
    ...
    /* Verify results */
    UtAssert_UINT32_EQ(HS_AppData.CDSData.ResetsPerformed, 1);
    UtAssert_UINT32_EQ(HS_AppData.CDSData.ResetsPerformedNot, (uint16)(~HS_AppData.CDSData.ResetsPerformed));
    UtAssert_UINT32_EQ(HS_AppData.CDSData.MaxResets, 2);
    UtAssert_UINT32_EQ(HS_AppData.CDSData.MaxResetsNot, (uint16)(~HS_AppData.CDSData.MaxResets));
...
{
    UtTest_Add(HS_AppMain_Test_NominalWaitForStartupSync,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppMain_Test_NominalWaitForStartupSync");
    UtTest_Add(HS_AppMain_Test_NominalRcvMsgSuccess,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppMain_Test_NominalRcvMsgSuccess");
    UtTest_Add(HS_AppMain_Test_NominalRcvMsgNoMessage,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppMain_Test_NominalRcvMsgNoMessage");
    UtTest_Add(HS_AppMain_Test_NominalRcvMsgTimeOut,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppMain_Test_NominalRcvMsgTimeOut");
    UtTest_Add(HS_AppMain_Test_NominalRcvMsgError,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_AppMain_Test_ProcessMainNotSuccess,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppMain_Test_ProcessMainNotSuccess");
    UtTest_Add(HS_AppMain_Test_SBSubscribeEVSLongError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppMain_Test_SBSubscribeEVSLongError");
    UtTest_Add(HS_AppMain_Test_SBSubscribeEVSShortError,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_AppInit_Test_CorruptCDSResetsPerformed,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_AppInit_Test_CorruptCDSResetsPerformed");
    UtTest_Add(HS_AppInit_Test_CorruptCDSMaxResets,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_AppInit_Test_DisableSavingToCDS,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_SbInit_Test_CreateSBCmdPipeError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_SbInit_Test_CreateSBCmdPipeError");
    UtTest_Add(HS_SbInit_Test_CreateSBEventPipeError,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_SbInit_Test_SubscribeHKRequestError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_SbInit_Test_SubscribeHKRequestError");
    UtTest_Add(HS_SbInit_Test_SubscribeGndCmdsError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_SbInit_Test_SubscribeGndCmdsError");
    UtTest_Add(HS_SbInit_Test_SubscribeWakeupError,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_TblInit_Test_RegisterAppMonTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_TblInit_Test_RegisterMsgActsTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_TblInit_Test_RegisterMsgActsTableError");
    UtTest_Add(HS_TblInit_Test_RegisterExeCountTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_TblInit_Test_RegisterExeCountTableError");
    UtTest_Add(HS_TblInit_Test_LoadExeCountTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_TblInit_Test_LoadExeCountTableError");
    UtTest_Add(HS_TblInit_Test_LoadAppMonTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_TblInit_Test_LoadAppMonTableError");
    UtTest_Add(HS_TblInit_Test_LoadEventMonTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_TblInit_Test_LoadEventMonTableError");
    UtTest_Add(HS_TblInit_Test_LoadMsgActsTableError,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_ProcessMain_Test_AlivenessDisabled,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_ProcessMain_Test_AlivenessDisabled");
    UtTest_Add(HS_ProcessMain_Test_WatchdogDisabled,
               HS_Test_Setup,
               HS_Test_TearDown,
    ...
    UtTest_Add(HS_ProcessCommands_Test_NullMsgPtr,
               HS_Test_Setup,
               HS_Test_TearDown,
               "HS_ProcessCommands_Test_NullMsgPtr");

    UtTest_Add(HS_ComputeStatusFlags_Test, HS_Test_Setup, HS_Test_TearDown, "HS_ComputeStatusFlags_Test");
